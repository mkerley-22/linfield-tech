  ...
  try {
    ...
    const item = await withRetry(
      ...
      data: {
        ...
        location,
        locationBreakdowns: locationBreakdowns !== undefined ? (locationBreakdowns || null) : undefined,
        usageNotes: usageNotes !== undefined ? (usageNotes || null) : undefined,
        availableForCheckout: availableForCheckout !== undefined ? (availableForCheckout || null) : undefined,
