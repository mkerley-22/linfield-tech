        ...
        <div className="relative h-32 mb-4 flex items-center justify-center">
          {fileCount > 0 ? (
            ...
            <svg width="1169" height="886" viewBox="0 0 1169 886" fill="none" className="w-32 h-24" style={{ maxHeight: '96px' }}>
              <path d="M2.73049 818.67C0.970488 813.69 0.000488281 808.34 0.000488281 802.78V48.94C0.000488281 21.91 22.6805 0 50.6605 0H392.36C408.94 0 424.95 5.9 437.33 16.56L529.521 96.02C541.901 106.68 557.9 112.58 574.49 112.58H959.151C987.131 112.58 1009.81 134.49 1009.81 161.52V225.33L2.73049 818.67Z" fill={color} />
